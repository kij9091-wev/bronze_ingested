view: bronze_mint_melon_chart {
  sql_table_name: `bronze_ingested.bronze_mint_melon_chart` ;;
...
view: bronze_mint_melon_chart__details {
  ...
  dimension: bronze_mint_melon_chart__details {
    type: string
    description: "추가 정보"
    hidden: yes
    sql: bronze_mint_melon_chart__details ;;
  }
  dimension: key {
    type: string
    sql: KEY ;;
